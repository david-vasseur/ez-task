        ...
        <div className="pt-20 min-h-screen flex flex-col gap-10 items-center justify-start bg-gray-600">
            <div className="flex justify-between w-[90vw] max-w-4xl">
                <div className="flex gap-2 items-center justify-center">
                    <span className="w-7 h-7 bg-gray-500 rounded-full"></span>
                    <p>A faire</p>
                </div>
                <div className="flex gap-2 items-center justify-center">
                    <span className="w-7 h-7 bg-yellow-500 rounded-full"></span>
                    <p>En cours</p>
                </div>
                <div className="flex gap-2 items-center justify-center">
                    <span className="w-7 h-7 bg-green-500 rounded-full"></span>
                    <p>Terminée</p>
                </div>
            </div>
